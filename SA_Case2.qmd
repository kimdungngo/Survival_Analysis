...
ggsurvplot(
  ...
  ylab = "Survival Probability",
  ggtheme = theme_light(),
  facet.by = "grade",           # Facet by grade
  surv.median.line = "hv",       # Add horizontal and vertical lines at median
...
l95s_sim <- l95s |>
  ...
  ggplot() + stat_pointinterval(aes(x=n.obs, y=l95, color=model), position = position_dodge(width=NULL))
```
